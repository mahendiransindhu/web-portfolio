  ...
  const projects = [
    {
      ...
      emoji: "🤖",
      category: "Academic",
      description: "Developed a robotic system to enhance soldier safety using Arduino, Bluetooth, and remote control. Designed 3D robot parts in Autodesk Fusion 360.",
    ...
    },
    {
      ...
      emoji: "📱",
      category: "Academic",
      description: "Built ARBOOK and ARGreeting apps for interactive reading and greeting cards using Unity, Vuforia, and ARCore.",
    ...
    },
    {
      ...
      description: "Worked on U-Analyze, U-Self Serve, and U-Assist at Uniphore to optimize customer support with Python, NLP, and Generative AI.",
  ...
  return (
    <div className="min-h-screen pt-24 px-6 pb-16">
      <div className="max-w-4xl mx-auto space-y-10">
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <button
                  ...
                  aria-label={isLiked(project.id) ? "Unlike" : "Like"}
                >
                  <Heart
              ...
              {/* Category */}
              <div className="inline-block px-2 py-1 rounded-full bg-indigo-100 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-800 text-xs mb-2">
                {project.category}
              </div>
        ...
        {/* Look for more projects */}
        <div className="space-y-5 text-center">
          <h2 className="text-xl md:text-2xl">
            Look for more <span className="text-indigo-600 dark:text-indigo-400">Projects</span>
          </h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            Explore more of my work on design and interactive projects:
          </p>
          <div className="flex justify-center gap-4">
            <a
              href="https://dribbble.com/sindhu21"
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 bg-indigo-100 dark:bg-indigo-950 rounded-lg text-indigo-600 dark:text-indigo-400 hover:bg-indigo-200 dark:hover:bg-indigo-900 transition-colors"
            >
              Dribbble
            </a>
            <a
              href="https://www.behance.net/sindhum3"
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 bg-indigo-100 dark:bg-indigo-950 rounded-lg text-indigo-600 dark:text-indigo-400 hover:bg-indigo-200 dark:hover:bg-indigo-900 transition-colors"
            >
        ...
        <div className="text-center p-6 rounded-xl bg-indigo-600 dark:bg-indigo-700">
          ...
          <p className="text-indigo-100 text-sm mb-4">
            I'd love to share detailed case studies in an interview!
          </p>
          <a href="/contact">
            <button className="px-5 py-2 bg-white text-indigo-600 rounded-lg hover:scale-105 transition-transform text-sm">
              Get in Touch
            </button>
          </a>
        </div>
